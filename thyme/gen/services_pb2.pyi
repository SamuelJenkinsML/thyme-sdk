...
class CommitRequest(_message.Message):
    __slots__ = ("message", "datasets", "pipelines", "featuresets", "sources", "allow_retention_narrowing", "backfill")
